...
def jsonable_encoder(obj: Any, custom_encoder: Optional[Dict[Any, Callable[[Any], Any]]] = None) -> Any:
    ...
    # Fast-path for most common immutable JSON types
    ...
    if isinstance(obj, pydantic.BaseModel):
        ...
        # Avoid unnecessary work if these keys don't exist
        if isinstance(obj_dict, dict):
            if "__root__" in obj_dict:
                obj_dict = obj_dict["__root__"]
            if isinstance(obj_dict, dict) and "root" in obj_dict:
    ...
    if isinstance(obj, dict):
        # Removed allowed_keys, as by default we only loop known keys/values
        return {
