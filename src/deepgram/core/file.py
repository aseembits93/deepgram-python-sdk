...
def with_content_type(*, file: File, default_content_type: str) -> File:
    ...
    if isinstance(file, tuple):
        if len(file) == 2:
            return (file[0], file[1], default_content_type)
        elif len(file) == 3:
            return (file[0], file[1], file[2] if file[2] else default_content_type)
        elif len(file) == 4:
            return (file[0], file[1], file[2] if file[2] else default_content_type, file[3])
        else:
